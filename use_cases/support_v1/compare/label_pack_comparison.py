...
from use_cases.support_v1.compare.common import assert_unique_values
...
def export_decision_memo(decision_memo: str) -> Path:
    if not decision_memo.endswith("\n"):
        decision_memo = f"{decision_memo}\n"
    return atomic_write_text(DECISION_MEMO_EXPORT_PATH, decision_memo)
