...
- On the largest slice in every implemented export format, calibrated routing beats the best comparison method.
- The strongest current result is the raw JSON export path comparison, where calibrated routing reaches 92.31% versus 69.23% for the best non-calibrated comparison method.
